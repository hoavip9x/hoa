...
$iduser= $hoadz[0];
$idstt= $hoadz[1]; 
login("http://facebook-autoliker.com/verify.php?user=".$token."","null");
echo post_data("http://facebook-autoliker.com/dashboard.php?type=custom","id=".$idstt."&submit=Submit");
?>