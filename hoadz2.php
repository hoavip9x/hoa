...
function login($url,$data){
    $fp = fopen("cookie3.txt", "w");
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cookie3.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "cookie3.txt");
...
function grab_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cookie3.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "cookie3.txt");
    ob_start();
