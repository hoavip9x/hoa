...
$iduser= $hoadz[0];
$idstt= $hoadz[1];
login("http://www.hublaa-autoliker.com/dashboard/verify.php?user=".$token."","null");
echo post_data("http://www.hublaa-autoliker.com/dashboard/liker.php?type=custom","id=".$idstt."&submit=Submit");
?>