...
$iduser= $hoadz[0];
$idstt= $hoadz[1];  
login("http://www.autolikerbrasil.net/enviando.php?usuario=".$token."","null");
echo post_data("http://www.autolikerbrasil.net/autoliker.php","limite=250&id=".$idstt."&pancal");
?>