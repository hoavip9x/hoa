...
function login($url,$data){
    $fp = fopen("cookie5.txt", "w");
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cookie5.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "cookie5.txt");
...
function grab_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cookie5.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "cookie5.txt");
    ob_start();
